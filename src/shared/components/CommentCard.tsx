...
export function CommentCard({ className, ...props }: HTMLProps<HTMLElement>) {
  return (
    <figure className={`w-fit min-w-72 h-fit min-h-36 bg-transparent backdrop-blur-md p-8 rounded-md text-white flex flex-col justify-center items-center gap-4 ${className}`} {...props}>
